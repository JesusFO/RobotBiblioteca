...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(78, 142);
			...
			this->groupBox1->Location = System::Drawing::Point(78, 34);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(343, 510);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(94, 510);
			...
			this->ClientSize = System::Drawing::Size(820, 565);
			...
			this->Text = L"frmMantRobot";
			this->Load += gcnew System::EventHandler(this, &frmMantRobot::frmMantRobot_Load);
