...
namespace RobotBibliotecaView {
	...
	/// <summary>
	/// Resumen de frmNuevoValoracionEntrega
	/// </summary>
	public ref class frmNuevoValoracionEntrega : public System::Windows::Forms::Form
	{
	public:
		frmNuevoValoracionEntrega(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(407, 268);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(50, 268);
			...
			this->Name = L"frmNuevoValoracionEntrega";
			this->Text = L"frmNuevoValoracionEntrega";
