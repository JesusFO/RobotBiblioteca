...
namespace RobotBibliotecaView {
	...
	/// <summary>
	/// Resumen de frmEditarRobot
	/// </summary>
	public ref class frmEditarRobot : public System::Windows::Forms::Form
	{
	public:
		frmEditarRobot(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(444, 305);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(67, 305);
			...
			this->ClientSize = System::Drawing::Size(599, 363);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"frmEditarRobot";
			this->Text = L"frmEditarRobot";
